...
var JobManager = module.exports = function JobManager(options){
    ...
    var blockHasher = (function () {
        // Verge blockhasher is always scrypt
        if(options.coin.symbol.toLowerCase() === 'xvg') {
            const scrypt = algos['scrypt'].hash({ nValue: 1024, rValue: 1 })

            return function (d) {
                return util.reverseBuffer(scrypt.apply(this, arguments));
            };
        }
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        const blockRewardMultiplier = typeof options.coin.blockRewardMultiplier !== 'undefined' ?
            options.coin.blockRewardMultiplier : 1;
        ...
        _this.emit('share', {
            ...
            blockReward: job.metaData.rewardToPool * blockRewardMultiplier,
            difficulty: difficulty / shareMultiplier,
